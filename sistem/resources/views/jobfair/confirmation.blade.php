					...
					<div class="step-pane active" data-step="1">
							...
							<div class="col-xs-12 col-sm-7">
								<div class="btn-group" data-toggle="buttons">
									<label class="btn btn-white">
										<input type="radio" name="pernah_pkl_dimedion" id="confirm_practical_yes" value="Yes"> Yes
									</label>
									<label class="btn btn-white">
										<input type="radio" name="pernah_pkl_dimedion" id="confirm_practical_no" value="No"> No
									</label>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-7">
								<div class="btn-group" data-toggle="buttons">
									<label class="btn btn-white">
										<input type="radio" name="pernah_psychotest_dimedion" id="confirm_followed_yes" value="Yes"> Yes
									</label>
									<label class="btn btn-white">
										<input type="radio" name="pernah_psychotest_dimedion" id="confirm_followed_no" value="No"> No
									</label>
								</div>
							</div>
						</div>
