						...
						<div class="step-pane active" data-step="1">
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-5">
										<select name="psychotest_venue" class="chosen-select form-control" id="form-field-select-3" data-placeholder="Choose ...">
											<option></option>
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-5">
										<select name="psychotest_venue" class="chosen-select form-control" id="form-field-select-3" data-placeholder="Choose ..." onchange='other_venue(this.value);'>
											<option></option>
