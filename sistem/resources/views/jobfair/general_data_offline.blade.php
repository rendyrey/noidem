<!--================================ General Data ==================== -->
<form class="form-horizontal" id="form_lamaran" action="{{url('tambah_pelamar_jobfair')}}" method="post" enctype="multipart/form-data" name="form_lamaran">
<div class="col-xs-12">
					...
					<div class="step-pane active" data-step="1">
						<div class="form-group">
							...
							<option value="">  </option>
								...
								<small id="com_adv_cat">This choice determines the open vacancies</small>
						...
						<div class="form-group" id="lbl_job_{{$a}}" hidden>
							...
							<div class="col-xs-12 col-sm-5">
								<select class="form-control" name="job_interest_{{$a}}" id="interest_{{$a}}" data-placeholder="Choose ...">
