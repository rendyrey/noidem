    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="clearfix">
          ...
          <div>
          <table id="institusi" class="table table-striped table-bordered table-hover">
          <thead>
          <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="smaller lighter blue no-margin">Tambah Data Institusi</h3>
      </div>
      ...
      {!! csrf_field() !!}            
        ...
        <div class="form-group">
          ...
          <select name = 'id_provinsi' class = 'form-control' style="width: 100%;" id="provinsis">
        ...
        <div class="form-group">
          <label>Kota</label>
          <select name = 'id_kota' class = 'form-control' style="width: 100%;" id="kotas">
...
<script type="text/javascript">
  var $provinsi = $( '#provinsis' ),
      $kota = $( '#kotas' ),
      $options = $kota.find( 'option' );
    
      $provinsi.on( 'change', function() {
      $kota.html( $options.filter( '[name="' + this.value + '"]' ) );
      } );
</script>
@stop