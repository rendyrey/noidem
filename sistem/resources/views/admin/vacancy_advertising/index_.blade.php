      ...
      <div class="alert alert-success fade in">
        ...
        @endif @if ($errors->any())
          <div class="alert alert-danger fade in">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
            <h4>
              <i class="icon fa fa-ban"></i> Perhatian !</h4>
              ...
              <div class="col-xs-12">
                <div class="clearfix">
                  <div class="pull-left tableTools-container">
                    <a class="btn btn-white btn-primary" data-toggle="modal" data-target="#myModal" title="Tambah Data">
                      <i class='fa fa-plus'></i> Tambah Header</a>
                    </div>
                  </div>
                  <button class="btn btn-md btn-success filter_vacancy" value="aktif">Aktif</button>
                  <button class="btn btn-md btn-danger filter_vacancy" value="tidak_aktif">Tidak Aktif</button>
                  <button class="btn btn-md btn-info filter_vacancy" value="semua">Semua</button>
                  <div class="row">
                    <div class="col-xs-12">
