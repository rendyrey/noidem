...
class TanggalPsikotes extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('event_position', function (Blueprint $table) {
            $table->increments('id');
            $table->string('event_vacancy_code');
            $table->string('no_reqruitment_request');
    ...
    {
        Schema::drop('tanggal_psychotest');
        Schema::drop('pelamar');
        Schema::drop('event_position');
    }
}
