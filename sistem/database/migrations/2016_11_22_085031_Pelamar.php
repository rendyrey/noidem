...
class Pelamar extends Migration
{
    ...
    public function up()
    {
        Schema::create('pelamar', function (Blueprint $table) {
            ...
            $table->string('job_interest_1')->nullable();
            $table->string('job_interest_2')->nullable();
            $table->string('job_interest_3')->nullable();
            $table->string('job_interest_4')->nullable();
            ...
            $table->integer('id_bidang_usaha')->nullable();
            ...
            $table->string('tgl_praktek_start', 25)->nullable();
            $table->string('tgl_praktek_end', 25)->nullable();
            $table->string('pernah_psychotest_dimedion');
            $table->string('tgl_psychotest_dimedion')->nullable();
            $table->string('status_pelamar', 25)->nullable();
