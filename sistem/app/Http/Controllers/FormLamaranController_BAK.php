    ...
    public function tambah(Request $request)
    {
        ...
        if ($data_exist) {
            ...
            if ($request->id_bidang_usaha == "") {
                ...
                //mendapatkan
                $syarat1 = KriteriaSyarat::where('id_syarat',$id_syarat1)->first();
                $syarat2 = KriteriaSyarat::where('id_syarat',$id_syarat2)->first();
                $syarat3 = KriteriaSyarat::where('id_syarat',$id_syarat3)->first();
                $syarat4 = KriteriaSyarat::where('id_syarat',$id_syarat4)->first();
