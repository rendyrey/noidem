...
class FormLamaranController extends Controller
{
    public function index()
    {
        ...
        $tanggal_psychotest = TanggalPsychotest::where('tanggal','>=', Carbon::now())->get();
        $iklan = Iklan::where('domain', 'formlamaran.medion.co.id')->where('actual_end_date', '>=', Carbon::now())->get();
        $arr_iklan = array();
            ...
            if($request->id_bidang_usaha == "") {
                ...
                if($level == "S1") {
                    ...
                    if($pelamar->status_pelamar == "Passed") {
                        ...
                        DB::table('loker')->where('id_iklan', $request->id_iklan)->where('no_rcr', $request->job_interest_1)->update(['actual_fresh' => $jml_actual_fresh1]);
                        DB::table('loker')->where('id_iklan', $request->id_iklan)->where('no_rcr', $request->job_interest_2)->update(['actual_fresh' => $jml_actual_fresh2]);
                        DB::table('loker')->where('id_iklan', $request->id_iklan)->where('no_rcr', $request->job_interest_3)->update(['actual_fresh' => $jml_actual_fresh3]);
                        DB::table('loker')->where('id_iklan', $request->id_iklan)->where('no_rcr', $request->job_interest_4)->update(['actual_fresh' => $jml_actual_fresh4]);
                        ...
                        DB::table('loker')->where('id_iklan', $request->id_iklan)->where('no_rcr', $request->job_interest_1)->update(['awaiting_fresh' => $jml_awaiting_fresh1]);
                        DB::table('loker')->where('id_iklan', $request->id_iklan)->where('no_rcr', $request->job_interest_2)->update(['awaiting_fresh' => $jml_awaiting_fresh2]);
                        DB::table('loker')->where('id_iklan', $request->id_iklan)->where('no_rcr', $request->job_interest_3)->update(['awaiting_fresh' => $jml_awaiting_fresh3]);
                        DB::table('loker')->where('id_iklan', $request->id_iklan)->where('no_rcr', $request->job_interest_4)->update(['awaiting_fresh' => $jml_awaiting_fresh4]);
            ...
            //Experience
                ...
                if($level == "S1") {
                    ...
                    if($pelamar->status_pelamar == "Passed") {
                        ...
                        DB::table('loker')->where('id_iklan', $request->id_iklan)->where('no_rcr', $request->job_interest_1)->update(['actual_exp' => $jml_actual_exp1]);
                        DB::table('loker')->where('id_iklan', $request->id_iklan)->where('no_rcr', $request->job_interest_2)->update(['actual_exp' => $jml_actual_exp2]);
                        DB::table('loker')->where('id_iklan', $request->id_iklan)->where('no_rcr', $request->job_interest_3)->update(['actual_exp' => $jml_actual_exp3]);
                        DB::table('loker')->where('id_iklan', $request->id_iklan)->where('no_rcr', $request->job_interest_4)->update(['actual_exp' => $jml_actual_exp4]);
