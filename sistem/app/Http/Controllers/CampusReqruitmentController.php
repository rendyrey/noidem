...
class CampusReqruitmentController extends Controller
{
    public function index()
    {
        ...
        return view('campusreqruitment.index', compact('bidang_usaha','institusi','kota','major','major_grup','provinsi','dateArray','months','yearArray','cur_year','attributes','tingkat_pendidikan'));
    }
}
